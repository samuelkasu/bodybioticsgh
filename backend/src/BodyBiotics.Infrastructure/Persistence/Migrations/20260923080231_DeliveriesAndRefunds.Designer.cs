...
namespace BodyBiotics.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260923080231_DeliveriesAndRefunds")]
    partial class DeliveriesAndRefunds
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BodyBiotics.Domain.Entities.Coupon", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(32)
                        .HasColumnType("character varying(32)")
                    ...
                    b.Property<int?>("MaxDiscountMinor")
                        .HasColumnType("integer")
                        .HasColumnName("max_discount_minor");

                    b.Property<int>("MinQuantity")
                        .HasColumnType("integer")
                        .HasColumnName("min_quantity");

                    b.Property<int>("MinSpendMinor")
                        .HasColumnType("integer")
                        .HasColumnName("min_spend_minor");
                    ...
                    b.Property<string>("ScopeSlugs")
                        .HasMaxLength(1000)
                        .HasColumnType("character varying(1000)")
                        .HasColumnName("scope_slugs");
                    ...
                    b.HasIndex("Active")
                        .HasDatabaseName("ix_coupons_active");
                    ...
                    b.ToTable("coupons", null, t =>
                        {
                            t.HasCheckConstraint("ck_coupon_min_spend_non_negative", "\"min_spend_minor\" >= 0");

                            t.HasCheckConstraint("ck_coupon_times_used_non_negative", "\"times_used\" >= 0");

                            t.HasCheckConstraint("ck_coupon_value_non_negative", "\"value\" >= 0");
                        });
                });

            modelBuilder.Entity("BodyBiotics.Domain.Entities.CouponRedemption", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(32)
                        .HasColumnType("character varying(32)")
                    ...
                    b.HasIndex("CouponId", "Email")
                        .HasDatabaseName("ix_coupon_redemptions_coupon_id_email");
            ...
            modelBuilder.Entity("BodyBiotics.Domain.Entities.Order", b =>
                {
                    ...
                    b.Property<int>("DeliveryFeeMinor")
                        .HasColumnType("integer")
                    ...
                    b.Property<string>("PaymentCheckoutUrl")
                        ...
                        .HasColumnName("payment_checkout_url");
                    ...
                    b.HasIndex("PaymentReference")
                        .HasDatabaseName("ix_orders_payment_reference");
            ...
            modelBuilder.Entity("BodyBiotics.Domain.Entities.OrderItem", b =>
                {
                    ...
                    b.Property<int?>("ListPriceMinor")
                        .HasColumnType("integer")
                        .HasColumnName("list_price_minor");
            ...
            modelBuilder.Entity("BodyBiotics.Domain.Entities.Product", b =>
                {
                    ...
                    b.Property<int?>("SalePriceMinor")
                        .HasColumnType("integer")
                        .HasColumnName("sale_price_minor");
            ...
            modelBuilder.Entity("BodyBiotics.Domain.Entities.ProductTag", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(32)
                        .HasColumnType("character varying(32)")
                    ...
                    b.Property<string>("BrandSlugs")
                        .HasMaxLength(1000)
                        .HasColumnType("character varying(1000)")
                        .HasColumnName("brand_slugs");

                    b.Property<string>("CategorySlugs")
                        .HasMaxLength(1000)
                        .HasColumnType("character varying(1000)")
                        .HasColumnName("category_slugs");
                    ...
                    b.HasIndex("Slug")
                        .IsUnique()
                        .HasDatabaseName("ix_product_tags_slug");

                    b.ToTable("product_tags", (string)null);
                });

            modelBuilder.Entity("BodyBiotics.Domain.Entities.Promotion", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(32)
                        .HasColumnType("character varying(32)")
                    ...
                    b.HasIndex("Active", "Priority")
                        .HasDatabaseName("ix_promotions_active_priority");

                    b.ToTable("promotions", null, t =>
                        {
                            t.HasCheckConstraint("ck_promotion_min_spend_non_negative", "\"min_spend_minor\" >= 0");

                            t.HasCheckConstraint("ck_promotion_value_non_negative", "\"value\" >= 0");
                        });
                });
            ...
            modelBuilder.Entity("BodyBiotics.Domain.Entities.CouponRedemption", b =>
                {
                    b.HasOne("BodyBiotics.Domain.Entities.Coupon", "Coupon")
